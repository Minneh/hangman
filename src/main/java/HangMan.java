...
public class Hangman{
  ...
  public static void main(String[] args) {
    ...
    while(weArePlaying){
      System.out.println("Welcome to my Hangman game!");//reddit ->r, e, d, d, i, t
      char[] randomWordToGuess = guesses[random.nextInt(guesses.length)].toCharArray();
      int amountOfGuesses = randomWordToGuess.length;
      char[] playerGuess = new char[amountOfGuesses];//creates empty char array where we will save user input
